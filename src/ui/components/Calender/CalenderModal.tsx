        ...
        <div className="headerContainer">
            <div className="date" onClick={calenderModal.toggleModalContent}>
                ...
                <svg width="12" height="18" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6065 7.77838L2.121 7.71618e-06L0 1.94426L7.425 8.75051L0 15.5568L2.121 17.501L10.6065 9.72263C10.8877 9.46478 11.0457 9.11511 11.0457 8.75051C11.0457 8.38591 10.8877 8.03623 10.6065 7.77838Z" fill="#00AAFF"/>
                </svg>
            </div>
